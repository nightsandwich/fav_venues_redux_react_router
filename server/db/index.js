...
const syncAndSeed = async()=> {
    ...
    const activity = await Type.create({name: 'Activity/Gym'});
    ...
    const metrorock = await Venue.create({name: 'Metrorock', visited: true, imageUrl: 'https://cdn.shortpixel.ai/spai/w_1082+q_lossy+ret_img+to_webp/https://bushwickdaily.com/wp-content/uploads/2021/04/N_moyr-yYhYbnzg5_PLs4Q-1024x768.jpg', website: 'https://www.metrorock.com/bushwick', typeId: activity.id, neighborhoodId: bushwick.id});
